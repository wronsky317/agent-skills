#!/usr/bin/env python3
"""
Reorder PowerPoint slides based on a sequence of indices.

Usage:
    python reorder.py template.pptx output.pptx 0,34,34,50,52

This will generate output.pptx using slides from template.pptx in the specified order.
