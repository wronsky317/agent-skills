...
**CRITICAL: Read this entire document before starting.** Important XML schema rules and formatting requirements are covered throughout. Incorrect implementation can create invalid PPTX files that PowerPoint cannot open.
...
4. **ESSENTIAL**: Remove or update any notes slide references in `_rels` files
