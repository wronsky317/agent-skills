#!/usr/bin/env python3
"""
Command line tool to check Office document XML files against XSD schemas and tracked changes.

Usage:
    python check.py <dir> --original <original_file>
"""
...
def main():
    parser = argparse.ArgumentParser(description="Check Office document XML files")
    parser.add_argument(
        "unpacked_dir",
