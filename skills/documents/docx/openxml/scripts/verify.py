#!/usr/bin/env python3
"""
Command line tool to verify Office document XML files against XSD schemas and tracked changes.

Usage:
    python verify.py <dir> --original <original_file>
"""
...
def main():
    parser = argparse.ArgumentParser(description="Verify Office document XML files")
    parser.add_argument(
        "unpacked_dir",
