...
### 0. Check Repository Governance

When creating or substantially rewriting a skill inside `/Users/wronsky/Documents/agent-skills`, also apply `skill-repo-governance` for repository-level consistency. Use it to check duplicate coverage, trigger overlap, progressive disclosure, and validation expectations.

Before creating a new skill:
- Search existing `skills/**/SKILL.md` files for overlapping names, descriptions, and use cases.
- Prefer updating an existing skill when the new workflow is only a variant.
- Create a new skill only when it has a distinct trigger, workflow, or reusable resource set.
- Plan references and scripts before adding directories.
...
5. Confirm there is a clear workflow/process and a verification or checklist section
6. Run `python3 scripts/validate-skills.py` from the skill repository root when editing `/Users/wronsky/Documents/agent-skills`
...
- [ ] Workflow/process is explicit enough to execute
- [ ] Verification evidence is named
- [ ] Consistent terminology throughout
- [ ] Examples are concrete, not abstract

### Structure
- [ ] Existing skills were checked for overlap before adding a new one
- [ ] File references are one level deep
- [ ] Progressive disclosure used appropriately
- [ ] Workflows have clear steps
- [ ] No time-sensitive information
- [ ] No empty `scripts/`, `references/`, or `assets/` directories were created
